...
set_property PACKAGE_PIN U2 [get_ports {seg[4]}]
set_property PACKAGE_PIN W4 [get_ports {seg[5]}]
set_property PACKAGE_PIN V4 [get_ports {seg[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports seg[*]]

#dp
set_property PACKAGE_PIN W3 [get_ports dp]
